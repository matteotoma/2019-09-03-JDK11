...
public class FoodDao {
	...
	public List<String> getTipiPorzione(Integer c){
		String sql = "SELECT DISTINCT(p.portion_display_name) AS t " + 
				"FROM `portion` AS p " + 
				"WHERE p.calories<? " + 
	...
	public List<Adiacenza> getAdiacenze(){
		String sql = "SELECT p1.portion_display_name AS t1, p2.portion_display_name t2, COUNT(*) peso " + 
				"FROM `portion` AS p1, `portion` p2 " + 
